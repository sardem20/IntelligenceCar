...
class Manutencao(db.Model):
    ...
    @classmethod
    def criar(cls, veiculo_id, tipo, descricao, data_manutencao, quilometragem, valor=0):
        manutencao = cls(
    ...
    def buscar_por_id(cls, manutencao_id):
        return db.session.get(cls, manutencao_id)

    def atualizar(self, tipo=None, descricao=None, data_manutencao=None, quilometragem=None, valor=None):
        if tipo is not None:
            self.tipo = tipo

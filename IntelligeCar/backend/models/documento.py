...
class Documento(db.Model):
    ...
    @classmethod
    def criar(cls, veiculo_id, tipo, data_emissao, data_validade):
        documento = cls(
    ...
    def buscar_por_id(cls, documento_id):
        return db.session.get(cls, documento_id)

    def atualizar(self, tipo=None, data_emissao=None, data_validade=None):
        if tipo is not None:
            self.tipo = tipo
